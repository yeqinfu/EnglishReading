...
package com.ppandroid.readenglish.utils.glide;
...
public abstract class GlideUtils {
    ...
    private static <T, K> DrawableTypeRequest<K> getDrawableTypeRequest(T context, K url) {
        ...
        try {
            if (context instanceof Fragment) {
                type = Glide.with((Fragment) context).load(url);
   ...
   /* public static Target<GlideDrawable> loadImageFormVideo(@NonNull String url, @NonNull ImageView imageView) {
    ...
    public static void displayImage(Context context,String imageUrls,ImageView imageView){
        ...
        loadImage(context,imageUrls,imageView,null, R.drawable.pic_default,R.drawable.pic_default);
    }
